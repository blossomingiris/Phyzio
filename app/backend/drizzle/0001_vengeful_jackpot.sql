...
ALTER TABLE "treatment_plans" ADD CONSTRAINT "treatment_plans_therapist_id_therapists_user_id_fk" FOREIGN KEY ("therapist_id") REFERENCES "public"."therapists"("user_id") ON DELETE restrict ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "therapists" DROP COLUMN "id";