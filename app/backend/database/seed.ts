...
async function seed() {
  ...
  try {
    ...
    const insertedUsers = await db
      ...
      .values([
        ...
        },
        {
          firstName: "Lucas",
          lastName: "Ferreira",
          email: "lucas.ferreira@phyzio.test",
          password: hashedPassword,
          role: "therapist",
        },
        {
    ...
    const [, sarahU, jamesU, mariaU, robertU, aishaU, lucasU, graceU, danielU] =
      insertedUsers;
    ...
    const insertedClients = await db
      ...
      .values([
        ...
        },
        {
          ...
          origin: "phone",
          preferredCommunication: "phone",
          medicalNotes: "Post-stroke rehabilitation, left-side weakness.",
        },
        {
          therapistId: robertU!.id,
          firstName: "Ava",
        ...
        },
        {
          ...
          origin: "other",
          preferredCommunication: "phone",
          medicalNotes: "Balance training after hip replacement.",
        },
        {
          ...
          origin: "whats_up",
          preferredCommunication: "whats_up",
          medicalNotes: "Post-cardiac surgery pulmonary rehab.",
        },
        {
        ...
        {
          therapistId: danielU!.id,
          firstName: "Jacob",
          lastName: "Reyes",
          birthDate: "1993-10-09",
          phone: "+1-202-555-0465",
          email: "jacob.reyes@example.com",
          origin: "phone",
          preferredCommunication: "phone",
          medicalNotes: "Vestibular rehabilitation for BPPV.",
        },
        {
          therapistId: jamesU!.id,
          firstName: "Mason",
